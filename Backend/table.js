...
// db.run(`CREATE TABLE allmovies(name TEXT PRIMARY KEY,rating,overview,img,time,release,director,writer,stars,genres,trailer,ott)`);
// sql = `INSERT INTO allmovies(name,rating,overview,img,time,release,director,writer,stars,genres,trailer,ott) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)`;
...
db.run(sql,["Rajkumar Hirani","images/uploads/cast5.jpg","Producer,Director,Writer,Editor","India",`Rajkumar Hirani is an Indian film director and editor. Hirani has directed five Hindi films, including Munna Bhai M.B.B.S., Lage Raho Munnabhai, 3 Idiots, PK and Sanju, and all of which have been commercial and critical successes. Most of which have won several awards, including the national awards. Among his awards, include 11 Filmfare Awards. He is the founder and owns the production house Rajkumar Hirani Films.`,"November 20, 1962","No info"])
